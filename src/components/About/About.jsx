      ...
      <div className="about__container container">
        <div className="about__content">
          <div className="about__text">
            ...
            <p className="about__description">
              Currently wearing two hats: pursuing graduate studies at SUNY Albany while crunching health analytics as a Student Assistant at the New York State Department of Health. Before trading Tokyo for the Empire State, I engineered solutions for Mercedes-Benz Japan while contracting with Infosys—proving that good code, like good cars, is built on precision and reliability.
            </p>
            <p className="about__description">
